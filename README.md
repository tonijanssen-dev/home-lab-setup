...
| Gerät | OS | Rolle |
|---|---|---|
| Windows Tower (RTX 3070, 32GB RAM) | Windows 11 | Gaming, Alltag, AI-Host |
...
- [Windows Tower](./windows-tower/)
  - [Ollama Installation](./windows-tower/ollama.md)
...
`Kali Linux` `Docker` `Ollama` `Metasploit` `Burp Suite` `DVWA` `Tailscale` `Samba` `TryHackMe` `Pwnagotchi` `Bettercap` `Tor`
